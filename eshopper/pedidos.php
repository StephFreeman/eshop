					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="login.html"><i class="fa fa-lock"></i> Iniciar sesión / Registrarse</a></li>
							</ul>
						</div>
					</div>
				</div>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#" class="active">Tienda<i
                                    ...
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="http://localhost/eshop-main/eshopper/shop.php">Catálogo</a></li>
										<li><a href="product-details.html">Productos</a></li> 
										<li><a href="http://localhost/eshop-main/eshopper/pedidos.php" class="active">Pedidos</a></li>
					...
					<thead>
						...
						<tbody>
							...
							<tr>	
								...
								<th><?php
								$ide = $row['bolsa_id'];
								$query2 = "SELECT imagen FROM bolsas WHERE id LIKE '%$ide%';";
								$res2 = mysqli_query($con, $query2);
								if ($row = mysqli_fetch_assoc($res2)){ ?>
									<img src="<?php echo $row['imagen'];?>"height="100px">
								<?php
								}
								?></th>
							</tr>
